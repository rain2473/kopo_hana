...
CREATE TABLE BOOK (
  ...
  store_date DATE DEFAULT SYSDATE CONSTRAINT nn_book_store_date NOT NULL,
  author VARCHAR2(100), 
...
CREATE TABLE resign (
  ...
  join_date DATE DEFAULT SYSDATE CONSTRAINT nn_resign_member_join_date NOT NULL,
  address VARCHAR2(100), 
...
CREATE TABLE RENT (
  ...
  rentalDate DATE DEFAULT SYSDATE CONSTRAINT nn_rent_rental_date NOT NULL,
  returnDate DATE, 
  remainDays NUMBER
);
