...
public class Book implements Comparable<Book>, Comparator<Book> {
	...
	public void setStoreDate(String storeDate) {
		this.informations.setStoreDate(storeDate);
	}

	public void setAuthor(String author) {
		this.informations.setAuthor(author);
	}

	public void setPulisher(String publisher) {
		this.informations.setPulisher(publisher);
	}

	public void setPulishingDate(String publishingDate) {
		this.informations.setPulishingDate(publishingDate);
	}

	public void setPrice(String price) {
		this.informations.setPrice(price);
	}
